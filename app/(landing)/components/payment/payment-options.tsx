...
const paymentList = [
    {
        bank_name: "BCA",
        account_number: 12146536,
        account_holder: "PT SportOn Digital"
    },
    {
        bank_name: "Mandiri",
        account_number: 89698543365,
        account_holder: "PT SportOn Digital"
    },
    {
        bank_name: "BRI",
        account_number: 6954369348586,
        account_holder: "PT SportOn Digital"
    },
]
        ...
        <CardWithHeader title="Payment Options">
            {
                paymentList.map((payment, index) => (
                    <div className="flex gap-5 p-5 border-b border-gray-100" key={index}>
                        <div className="bg-blue-100 p-4 blue-500 h-fit self-center">
                        ...
                        <div className="ml-auto bg-gray-blue-50 text-gray-800 text-xs h-fit self-center px-2 py-1">
                            Bank Transfer
                            </div>
                    </div>
                ))
